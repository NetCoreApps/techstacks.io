import { combinePaths, JsonServiceClient, toFormData } from '@servicestack/client'
...
export async function init() {
    ...
    return await Promise.all([
        ...
        client.post(new dtos.Authenticate())
            .then(r => {
                authCtx.signIn(r)
            }).catch(() => {
            authCtx.signOut()
...
export const queryTechnology = async (query: any) => {
  return await client.get(new dtos.QueryTechnology(query), { include: 'total' });
};
...
export const deletePostComment = async (id: number, postId: number) => {
...
export const addLabel = async (args: any) => {
  return await client.post(new dtos.AddOrganizationLabel(args));
};

export const updateLabel = async (args: any) => {
  return await client.put(new dtos.UpdateOrganizationLabel(args));
};
...
export const updateCategory = async (args: any) => {
  return await client.put(new dtos.UpdateOrganizationCategory(args));
};
...
export const addMember = async (args: any) => {
  return await client.post(new dtos.AddOrganizationMember(args));
};

export const updateMember = async (args: any) => {
  return await client.put(new dtos.UpdateOrganizationMember(args));
};
...
export const addFavoriteTechnology = async (technologyId: number) => {
  const request = new dtos.AddFavoriteTechnology({ technologyId });
  return (await client.put(request)).result;
};

export const removeFavoriteTechnology = async (technologyId: number) => {
  const request = new dtos.RemoveFavoriteTechnology({ technologyId });
  return (await client.delete(request)).result;
};

export const addFavoriteTechStack = async (technologyStackId: number) => {
  const request = new dtos.AddFavoriteTechStack({ technologyStackId });
  return (await client.put(request)).result;
};

export const removeFavoriteTechStack = async (technologyStackId: number) => {
  const request = new dtos.RemoveFavoriteTechStack({ technologyStackId });
  return (await client.delete(request)).result;
};
