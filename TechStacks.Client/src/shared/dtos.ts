...
// @Route("/ping")
export class Ping implements IGet
{
...
export class UserPostCommentVote implements IReturn<UserPostCommentVoteResponse>, IPut
{
    public id?: number;
    public postId?: number;
    public weight?: number;
...
export class FindTechnologies extends QueryDb_2<Technology, TechnologyView> implements IReturn<QueryResponse<TechnologyView>>
{
    public ids: number[];
    public name: string;
    public vendorName: string;
...
export class QueryTechnology extends QueryDb_2<Technology, TechnologyView> implements IReturn<QueryResponse<TechnologyView>>
{
    public ids: number[];
    public name: string;
    public vendorName: string;
...
export class FindTechStacks extends QueryDb_2<TechnologyStack, TechnologyStackView> implements IReturn<QueryResponse<TechnologyStackView>>
{
    public ids: number[];
    public name: string;
    public vendorName: string;
...
export class QueryTechStacks extends QueryDb_2<TechnologyStack, TechnologyStackView> implements IReturn<QueryResponse<TechnologyStackView>>
{
    public ids: number[];
    public name: string;
    public vendorName: string;
...
export class QueryPostComments extends QueryDb_1<PostComment> implements IReturn<QueryResponse<PostComment>>
{
    public id?: number;
    public userId?: number;
    public postId?: number;
